package com.scan.me.Follow.Follower;
...
import com.scan.me.CustomerSubmittion.SubmitAdapter;
...
public class FollowerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child(UID).child("Follower");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<FollowAdapter, FollowerActivity.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter
                <FollowAdapter, FollowerActivity.BlogViewHolder>(
                FollowAdapter.class,
                R.layout.follow_row,
                FollowerActivity.BlogViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(final FollowerActivity.BlogViewHolder viewHolder, final FollowAdapter model, int position) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(FollowerActivity.this, EntryActivity.class);
