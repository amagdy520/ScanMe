package com.scan.me.UserProfile.NewDocument;
...
public class NewDocument extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(NewDocument.this, R.style.AppTheme_Dark_Dialog);
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NewDocument.this,EntryActivity.class);
        ...
        mModify_eName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(NewDocument.this);
                LayoutInflater inflater = NewDocument.this.getLayoutInflater();
        ...
        mModify_eDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(NewDocument.this, date, myCalendar
        ...
        mModifyFields.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.showDialog(NewDocument.this);
            }
        });
        m_eSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.equals("Name")||date.equals("Date")||desc.equals("Description")||add.equals("Address")||field.equals("Fields")){
                    Toast.makeText(NewDocument.this,"Please, Fill Data",Toast.LENGTH_SHORT).show();
                }else{
                    progressDialog.show();
                    ...
                    filepath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            if(!mImageUri.equals(null)) {
                                ...
                                startActivity(new Intent(NewDocument.this, UserProfile.class));
